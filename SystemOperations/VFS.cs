...
namespace Atypical.VirtualFileSystem.Core
{
    ...
    /// </summary>
    public partial class VFS : IVirtualFileSystem
    {
        /// <summary>
        ...
        public VFSPath RootPath => Root.Path;
        ...
        private void AddToIndex(IVirtualFileSystemNode node)
        {
            ...
            if (node.Path.Parent is not null && !Index.ContainsKey(node.Path.Parent) && node.Path.Parent != Root.Path)
            {
