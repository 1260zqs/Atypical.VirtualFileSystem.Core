...
namespace Atypical.VirtualFileSystem.Core
{
    ...
    /// </summary>
    public class VFSDirectoryPath : VFSPath
    {
        /// <summary>
        ...
        public VFSDirectoryPath(string path) : base(path)
        {
        ...
        public static implicit operator VFSDirectoryPath(string path) => new VFSDirectoryPath(path);
